...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Espejo Software | South Florida Software Company', description: 'Custom web apps, mobile apps, MVPs, and websites for businesses across West Palm Beach, Loxahatchee, The Acreage, and South Florida.', type: 'website', url: 'https://espejosoftware.com', locale: 'en_US', images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Espejo Software — Software built around your business.' }] },
